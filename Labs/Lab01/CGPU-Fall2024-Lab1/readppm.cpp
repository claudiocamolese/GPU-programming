...
/*!  Write data into ppm format
 \param[in] filename (char*): name of the file in which the data will be written
 \param[in] height (int):  height of the image 
 \param[in] width (int):  width of the image 
 \param[in] data (unsigned char): pointer to the data image to be written 
*/
...
/*!  Write data into ppm format
 \param[in] filename (char*): name of the file from which data will be read from
 \param[in] height (int):  height of the image 
 \param[in] width (int):  width of the image 
 \param[out]  (unsigned char): pointer to the data image to be reade 
*/
